...
export const STONE_MATERIALS = [
  ...
  },
  {
    ...
    statBonus: { fireRate: 0.2, bulletSpeed: 0.2 },
    behavior: null,
  ...
  },
  {
    ...
    statBonus: { maxHp: 0.2, radius: 0.2, knockback: 0.2 },
    behavior: null,
...
const ALL_STONE_SPECIAL_ITEMS = [
  { key: "heavyStone", name: t("stone.item.heavyStone.name"), nameKey: "stone.item.heavyStone.name", description: t("stone.item.heavyStone.description"), descriptionKey: "stone.item.heavyStone.description", category: "special", tags: ["hp", "boulder", "knockback"], recipe: ["hpMaterial", "hpMaterial"], statBonus: {}, behavior: { effect: "heavy", value: 1 }, weight: 0.05 },
  { key: "critStone", name: t("stone.item.critStone.name"), nameKey: "stone.item.critStone.name", description: t("stone.item.critStone.description"), descriptionKey: "stone.item.critStone.description", category: "special", tags: ["critical", "damage"], recipe: ["powerMaterial", "powerMaterial"], statBonus: {}, behavior: { effect: "criticalChance", value: 0.25 }, weight: 0.05 },
  { key: "bounceStone", name: t("stone.item.bounceStone.name"), nameKey: "stone.item.bounceStone.name", description: t("stone.item.bounceStone.description"), descriptionKey: "stone.item.bounceStone.description", category: "special", tags: ["range", "ricochet", "targeting"], recipe: ["durationMaterial", "durationMaterial"], statBonus: {}, behavior: { effect: "ricochetCount", value: 1 }, weight: 0.05 },
  { key: "machineGunStone", name: t("stone.item.machineGunStone.name"), nameKey: "stone.item.machineGunStone.name", description: t("stone.item.machineGunStone.description"), descriptionKey: "stone.item.machineGunStone.description", category: "special", tags: ["speed", "fireRate", "damage"], recipe: ["frequencyMaterial", "frequencyMaterial"], statBonus: {}, behavior: { effect: "machineGun", value: 1 }, weight: 0.05 },
  { key: "explosiveStone", name: t("stone.item.explosiveStone.name"), nameKey: "stone.item.explosiveStone.name", description: t("stone.item.explosiveStone.description"), descriptionKey: "stone.item.explosiveStone.description", category: "special", tags: ["hp", "power", "explosion", "area"], recipe: ["hpMaterial", "powerMaterial"], statBonus: {}, behavior: { effect: "explosionDamage", value: 0.35 }, weight: 0.05 },
  { key: "flameStone", name: t("stone.item.flameStone.name"), nameKey: "stone.item.flameStone.name", description: t("stone.item.flameStone.description"), descriptionKey: "stone.item.flameStone.description", category: "special", tags: ["hp", "range", "fire", "trail"], recipe: ["hpMaterial", "durationMaterial"], statBonus: {}, behavior: { effect: "damageTrail", value: 1 }, weight: 0.05 },
  { key: "satelliteStone", name: t("stone.item.satelliteStone.name"), nameKey: "stone.item.satelliteStone.name", description: t("stone.item.satelliteStone.description"), descriptionKey: "stone.item.satelliteStone.description", category: "special", tags: ["hp", "speed", "orbit"], recipe: ["hpMaterial", "frequencyMaterial"], statBonus: {}, behavior: { effect: "satellite", value: 1 }, weight: 0.05 },
  { key: "laserStone", name: t("stone.item.laserStone.name"), nameKey: "stone.item.laserStone.name", description: t("stone.item.laserStone.description"), descriptionKey: "stone.item.laserStone.description", category: "special", tags: ["power", "range", "laser", "line"], recipe: ["powerMaterial", "durationMaterial"], statBonus: {}, behavior: { effect: "playerBeam", value: 1 }, weight: 0.05 },
  { key: "multiThrow", name: t("stone.item.multiThrow.name"), nameKey: "stone.item.multiThrow.name", description: t("stone.item.multiThrow.description"), descriptionKey: "stone.item.multiThrow.description", category: "special", tags: ["power", "speed", "projectileCount"], recipe: ["powerMaterial", "frequencyMaterial"], statBonus: {}, behavior: { effect: "projectileCount", value: 1 }, weight: 0.05 },
  { key: "piercingStone", name: t("stone.item.piercingStone.name"), nameKey: "stone.item.piercingStone.name", description: t("stone.item.piercingStone.description"), descriptionKey: "stone.item.piercingStone.description", category: "special", tags: ["range", "speed", "pierce", "wallBounce"], recipe: ["durationMaterial", "frequencyMaterial"], statBonus: {}, behavior: { effect: "pierce", value: 1 }, weight: 0.05 },
];
