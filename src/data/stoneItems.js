...
export const STONE_SPECIAL_ITEMS = [
  ...
  { key: "heavyStone", name: t("stone.item.heavyStone.name"), nameKey: "stone.item.heavyStone.name", description: t("stone.item.heavyStone.description"), descriptionKey: "stone.item.heavyStone.description", category: "special", tags: ["knockback", "heavy", "damage"], recipe: ["hpMaterial"], statBonus: { radius: 0.2, knockbackFlat: 22, damage: 0.18 }, behavior: { effect: "heavyHit", value: 1 }, weight: 0.06 },
