...
export const WEAPON_POOL = [
  ...
  },
  {
    ...
    weapon: {
      ...
      ricochetSpeedScale: 1.1,
      splitSpawnLimit: 10,
      kick: 1.6,
      bulletTint: [1, 0.92, 0.42],
      bulletGlow: "glowAmber",
      bulletSprite: "stoneBouncy",
      stoneVisual: { form: "bouncy", sizeScale: 1.15, trail: "orange", hitEffect: "bounce" },
      stoneFlags: { rubber: true },
    },
  },
  {
    name: "隕石核",
    rarity: "legend",
    text: "黒赤い隕石核を投げ、大爆発と破片で敵群を砕く。",
    weapon: {
      baseName: "石",
      rarity: "legend",
      variantSummary: "巨大隕石化。着弾大爆発、中心高火力、破片6個、攻撃頻度-10%",
      damage: 56.7,
      fireRate: 0.81,
      bulletSpeed: 430,
      life: 1.05,
      ...
      splitSpawnLimit: 10,
      kick: 2.8,
      bulletTint: [0.78, 0.18, 0.14],
      bulletGlow: "glowRed",
      bulletSprite: "stoneMeteor",
      effectTint: [1, 0.26, 0.16],
      effectGlow: "glowRed",
      stoneVisual: { form: "meteor", sizeScale: 1.35, trail: "red", hitEffect: "explosion" },
      stoneFlags: { meteor: true },
    },
  },
  {
    name: "名人の一石",
    rarity: "legend",
    text: "通常投石に加え、高HP敵へ一定間隔で白く光る精密投石を放つ。",
    weapon: {
      baseName: "石",
      rarity: "legend",
      variantSummary: "2.5秒ごとに高HP敵へ確定会心の精密投石",
      damage: 42,
      fireRate: 0.9,
      bulletSpeed: 390,
      life: 1.15,
      ...
      radius: 14,
      pierce: 1,
      masterStoneInterval: 2.5,
      masterStoneDamageScale: 2.8,
      masterStoneEliteBossBonus: 0.25,
      kick: 2.2,
      bulletTint: [0.9, 0.92, 0.98],
      bulletGlow: "glowCyan",
      bulletSprite: "stoneSharp",
      stoneVisual: { form: "sharp", sizeScale: 1.15, trail: "white", hitEffect: "critical" },
      stoneFlags: { master: true },
    },
  },
  {
    name: "火炎放射器",
  ...
  },
  {
    name: "ナイフ",
    rarity: "normal",
    text: "高速で小型ナイフを投げる、手数と会心の武器。",
    weapon: {
      baseName: "ナイフ",
      rarity: "normal",
      variantSummary: "低威力だが高頻度・高速。会心率+12%",
      kind: "projectile",
      damage: 18,
      fireRate: 4.1,
      bulletSpeed: 840,
      ...
      critMultiplier: 1.8,
      kick: 0.8,
      bulletTint: [0.86, 0.92, 1],
      bulletGlow: "glowCyan",
      bulletSprite: "knifeBlade",
      stoneVisual: { trail: "white", hitEffect: "normal" },
    },
  },
  {
    name: "ブーメラン",
  ...
  },
  {
    name: "弓",
    rarity: "normal",
    text: "遠くの敵へ高速の矢を放つ、長射程の貫通武器。",
    weapon: {
      baseName: "弓",
      rarity: "normal",
      variantSummary: "長射程・貫通+1",
      kind: "projectile",
      damage: 38,
      fireRate: 1.3,
      bulletSpeed: 920,
      ...
      knockback: 3,
      kick: 1.6,
      bulletTint: [0.95, 0.86, 0.58],
      bulletGlow: "glowAmber",
      bulletSprite: "arrow",
      stoneVisual: { trail: "white", hitEffect: "pierce" },
    },
  },
  {
    name: "雷の杖",
    rarity: "normal",
    text: "最寄りの敵へ落雷し、近くの敵へ青白い雷が連鎖する。",
    weapon: {
      baseName: "雷の杖",
      rarity: "normal",
      variantSummary: "最大3回連鎖。密集に強い",
      kind: "chain",
      damage: 26,
      fireRate: 1.4,
      bulletSpeed: 1,
      ...
      knockback: 1,
      kick: 1.4,
      effectTint: [0.58, 0.92, 1],
      effectGlow: "glowCyan",
      bulletSprite: "lightningStaff",
    },
  },
  {
    name: "地雷",
    rarity: "normal",
    text: "足元の後方に地雷を設置し、敵が踏むと爆発する。",
    weapon: {
      baseName: "地雷",
      rarity: "normal",
      variantSummary: "設置上限8。起動後に接近した敵へ爆発",
      kind: "mine",
      damage: 0,
      explosionDamage: 66,
      explosionRadius: 82,
      ...
      radius: 11,
      kick: 1.4,
      bulletTint: [0.72, 0.74, 0.8],
      bulletGlow: "glowRed",
      bulletSprite: "mine",
      effectTint: [1, 0.44, 0.18],
      effectGlow: "glowRed",
    },
  },
  {
    name: "爆弾",
    rarity: "normal",
    text: "敵方向へ黒い爆弾を投げ、命中または導火線で大爆発する。",
    weapon: {
      baseName: "爆弾",
      rarity: "normal",
  ...
  },
  {
    name: "剣",
    rarity: "normal",
    text: "向いている方向へ瞬間的な白い斬撃を出す近接武器。",
    weapon: {
      baseName: "剣",
      rarity: "normal",
      variantSummary: "短射程・高ノックバックの扇状斬撃",
      kind: "sword",
      damage: 50,
      fireRate: 1.6,
      bulletSpeed: 1,
  ...
  },
  {
    name: "毒瓶",
    rarity: "normal",
    text: "敵付近に瓶を投げ、着弾地点へ継続ダメージの毒沼を作る。",
    weapon: {
      baseName: "毒瓶",
      rarity: "normal",
      variantSummary: "毒沼で継続ダメージ。軽い鈍足つき",
      kind: "poisonBottle",
      damage: 10,
      tickRate: 3.5,
      fireRate: 0.95,
      ...
      freezeDuration: 0.65,
      kick: 1.2,
      bulletTint: [0.48, 1, 0.36],
      bulletGlow: "glowCyan",
      bulletSprite: "poisonBottle",
      effectTint: [0.34, 1, 0.36],
      effectGlow: "glowCyan",
    },
  },
  {
    name: "氷の杖",
    rarity: "normal",
    text: "水色の氷弾で敵単体を撃ち、強い鈍足を与える。",
    weapon: {
      baseName: "氷の杖",
      rarity: "normal",
      variantSummary: "命中時に移動速度50%低下",
      kind: "projectile",
      damage: 24,
      fireRate: 1.5,
      bulletSpeed: 700,
      ...
      freezeDuration: 1.9,
      kick: 1.1,
      bulletTint: [0.66, 0.94, 1],
      bulletGlow: "glowCyan",
      bulletSprite: "iceShard",
      effectTint: [0.58, 0.9, 1],
      effectGlow: "glowCyan",
      stoneVisual: { trail: "white", hitEffect: "normal" },
    },
  },
  {
    name: "ドローン",
    rarity: "normal",
    text: "プレイヤー周囲を旋回する小型機が近くの敵へ自律射撃する。",
    weapon: {
      baseName: "ドローン",
      rarity: "normal",
      variantSummary: "1機の自律ドローンが射撃",
      kind: "drone",
      damage: 15,
      fireRate: 2.4,
      bulletSpeed: 620,
      ...
      radius: 5,
      kick: 0.6,
      bulletTint: [0.74, 0.96, 1],
      bulletGlow: "glowCyan",
      bulletSprite: "droneShot",
      effectTint: [0.62, 0.9, 1],
      effectGlow: "glowCyan",
    },
  }
];
